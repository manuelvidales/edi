...
//validar formato archivos .txt y con codigo #204
        ...
        //almacenar en mysql
            $savefile = DB::table('edidaimlers')->insert(['code' => 204,'filename' => $filename, 'shipment_id' => $shipment_identification_number,'purpose_code' => $purpose_code,'s5total' => $count-1,'created_at' => $today->format('Y-m-d H:i:s'),'updated_at' => $today->format('Y-m-d H:i:s')]);
            ...
            elseif ($purpose_code == '05') { //Si es 05 Actualizar Fechas y notificar
                ...
                //actualizar fechas SqlSrv tabla edi_daimler_204 txt204
                    ...
                    //graba el nombre de archivo para no volver a leerlo
                        $save204_05 = DB::table('edidaimlers')->insert(['code' => 204,'filename' => $filename, 'shipment_id' => $shipment_identification_number,'purpose_code' => $purpose_code,'s5total' => $count-1,'created_at' => $today->format('Y-m-d H:i:s'),'updated_at' => $today->format('Y-m-d H:i:s')]);
            ...
            elseif ($purpose_code == '01') { //Si es 01 se Cancela pedido, actualizar y Notificar
                ...
                if ($val01->purpose_code === '01') {
                    ...
                    if (empty($update01)) { Log::critical('Fallo al actualizar datos purpose:01 en tabla edi_daimler_204'); }
                        ...
                        Log::info('pedido actualizado purpose:05');
                    //graba el nombre de archivo para no volver a leerlo
                        $save204_01 = DB::table('edidaimlers')->insert(['code' => 204,'filename' => $filename,'shipment_id' => $shipment_identification_number,'purpose_code' => $purpose_code,'s5total' => $count-1,'created_at' => $today->format('Y-m-d H:i:s'),'updated_at' => $today->format('Y-m-d H:i:s')]);
                    ...
                    //Notificar por correo
                        ...
                        if (empty($data990)) { }//si es null no hacer nada
                            ...
                            //validar update990
                            if (empty($update990)) { Log::warning('Fallo actualizacion edi_daimler_990 ');}
            ...
            if (empty($buscar824)) {
                ...
                $local = 'public/storage/'.$filename; //ruta para almacenar
                    if (ftp_get($conn_id, $local, $filename, FTP_BINARY)) { //descarga
                        ...
                        //almacenar en mysql
                        $savefile824 = DB::table('edidaimlers')->insert(['code' => 824,'filename' => $filename, 'shipment_id' => $REF_shipment_identification_number,'created_at' => $today->format('Y-m-d H:i:s'),'updated_at' => $today->format('Y-m-d H:i:s')]);
