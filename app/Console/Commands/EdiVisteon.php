        ...
        if (empty($sql)) {
            ...
            foreach ($sql as $row) {
                if ($row->send_txt == '0') { //no hacer nada...
                    ...
                    $filename3 = $row->B311_alpha_code.'_VISTEON_210_(SendTxT3)'.date('Ymd', strtotime($row->B309_dalivery_date)).'_'.$idnew;
